...
PicGoGithubToken：`b645e49c93247cd32a0cc5ced6f8e7560e625688`
...
> 查看
> - 查看PicGo设置-日志文件 picgo.og
> - 查看PicGo设置-配置文件`data.json`确认配置中各项没有多余的空格或其他字符
路径：C:\Users\Administrator\AppData\Roaming\picgo\data.json

> 参考
> [查看官方Issues · Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc)
> [PicGo+Github图床配置，以及服务端出错及上传失败的一些坑CSDN博客](https://blog.csdn.net/twodogbanana/article/details/95609760)
> - github里面的仓库名是没有空格的（空格用 ‘-’ 代替）所以如果之前命名的仓库名称有空格github会自动帮你转换。例如：codetwo dog 转换为 code-two-dog
> - 文件名里不能有 ‘+’ 号，有 ‘+’ 就上传不成功。

1. 上传图片错误
github上重创建token，粘贴到PicGoToken即可成功上传图片到github

![](https://raw.githubusercontent.com/ld269440877/images/master/AliyunNotebook/PicGoStatusCodeError401Badcredentials.png)
