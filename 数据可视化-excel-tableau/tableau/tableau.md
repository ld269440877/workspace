...
![](显示隐藏的工作表-选中仪表板中的工作表或者右击仪表板取消隐藏.png)
![](制作多表联动的筛选器.png)
...
- 可以和图形结合使用。
### 常用图形
![产品销售热力图表](高级-产品销售热力图表.png "产品销售热力图表")
![绩效考核图表](高级-绩效考核图表.png "绩效考核图表")
![销售日历图表](高级-销售日历图表.png "销售日历图表")
## 桑吉图
### 何时使用
- 用于反映事物有方向性的流转
- 既要反映流转方向又要反映流转多少时候。
### 使用技巧
和柱状图结合使用。
![产品流向分布桑吉图](高级-产品流向分布桑吉图.png "产品流向分布桑吉图")
